...
from cool.semantic3.util.structure import *
from cool.semantic3.util.structure import _allClasses as classDict

from cool.semantic3.util.structure import lookupClass
    ...
    def exitMethod(self, ctx: coolParser.MethodContext):
        ...
        try:
            ...
            if not expression_type.conformsTo(return_type):
                raise lubtest("Expression type: ", expression_type.name, "must conform to return type: ",
                              return_type.name)
